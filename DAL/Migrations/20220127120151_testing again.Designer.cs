...
namespace DAL.Migrations
{
    ...
    [Migration("20220127120151_testing again")]
            ...
            modelBuilder.Entity("DAL.Models.Expense", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryNavId = 1,
                            Comment = "Glass",
                            ExpenseDate = new DateTime(2022, 1, 27, 13, 1, 51, 380, DateTimeKind.Local).AddTicks(6123),
                            UserNavId = 1
                        });
                });
            ...
            modelBuilder.Entity("DAL.Models.ExpenseCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryName = "Snacks",
                            CreationDate = new DateTime(2022, 1, 27, 13, 1, 51, 380, DateTimeKind.Local).AddTicks(6109),
                            UserNavId = 1
                        });
                });
            ...
            modelBuilder.Entity("DAL.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2022, 1, 27, 13, 1, 51, 380, DateTimeKind.Local).AddTicks(5933),
                            Fname = "Julia",
                            Lname = "Hook",
                            Password = "Testing123",
                            UserName = "JuliaH"
                        ...
                        {
                            Id = 2,
                            CreationDate = new DateTime(2022, 1, 27, 13, 1, 51, 380, DateTimeKind.Local).AddTicks(5969),
                            Fname = "Alexander",
                            Lname = "Volonen",
                            Password = "Testing234",
                            UserName = "AlexV"
                        ...
                        {
                            Id = 3,
                            CreationDate = new DateTime(2022, 1, 27, 13, 1, 51, 380, DateTimeKind.Local).AddTicks(5971),
                            Fname = "Stefan",
                            Lname = "Krakowsky",
                            Password = "Testing345",
                            UserName = "Peppo"
                        ...
                        {
                            Id = 4,
                            CreationDate = new DateTime(2022, 1, 27, 13, 1, 51, 380, DateTimeKind.Local).AddTicks(5973),
                            Fname = "Winnie",
                            Lname = "Huynh",
                            Password = "Testing456",
                            UserName = "WinnieH"
                        ...
                        {
                            Id = 5,
                            CreationDate = new DateTime(2022, 1, 27, 13, 1, 51, 380, DateTimeKind.Local).AddTicks(5976),
                            Fname = "Eric",
                            Lname = "Flodin",
                            Password = "Testing567",
                            UserName = "Ericx"
                        ...
                        {
                            Id = 6,
                            CreationDate = new DateTime(2022, 1, 27, 13, 1, 51, 380, DateTimeKind.Local).AddTicks(5977),
                            Fname = "Anders",
                            Lname = "Bergstrom",
                            Password = "Testing678",
                            UserName = "AndersB"
                        ...
                        {
                            Id = 7,
                            CreationDate = new DateTime(2022, 1, 27, 13, 1, 51, 380, DateTimeKind.Local).AddTicks(5979),
                            Fname = "Peter",
                            Lname = "Hafid",
                            Password = "Testing789",
                            UserName = "PeterH"
